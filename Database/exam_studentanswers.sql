...
CREATE TABLE `studentanswers` (
  ...
  `AnswerOption` varchar(15) DEFAULT 'E',
  `Answer` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`StudentID`,`QuestionPaperID`,`QuestionID`),
...
INSERT INTO `studentanswers` VALUES (1,'ut1',112,'E',NULL),(1,'ut1',113,'E',NULL),(1,'ut1',116,'E',NULL),(1,'ut1',117,'E',NULL),(1,'ut1',118,'E',NULL);
